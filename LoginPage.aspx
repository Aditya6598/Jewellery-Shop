 ...
 <td onmouseover="showmenu('fairs')" onmouseout="hidemenu('fairs')">
  ...
  <td onmouseover="showmenu('trsch')" onmouseout="hidemenu('trsch')">
   ...
   <tr><td class="menu"><a href="AboutUS.aspx">ABOUT US</a></td></tr>
         ...
         <tr>
<BR><p align="center" style="line-height:100%; margin-top:6; margin-bottom:3;"><b><font color="green">To access this feature:....</b><br><BR>
</tr>
<tr><a><center><font color="green">Please login with your  Account </center> </a></tr>
</table>
        ...
        <asp:TextBox ID="TextBox2" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
                        ErrorMessage="Enter Password"></asp:RequiredFieldValidator><br />
        <br />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp;&nbsp;
